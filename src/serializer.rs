...
impl Serializer {
    ...
    fn serialize_bare_item(input_bare_item: &BareItem, output: &mut String) -> Res<()> {
    ...
    fn serialize_parameters(input_params: &Parameters, output: &mut String) -> Res<()> {
    ...
    fn serialize_key(input_key: &str, output: &mut String) -> Res<()> {
    ...
    fn serialize_integer(value: i64, output: &mut String) -> Res<()> {
    ...
    fn serialize_decimal(value: Decimal, output: &mut String) -> Res<()> {
    ...
    fn serialize_string(value: &str, output: &mut String) -> Res<()> {
        // https://httpwg.org/http-extensions/draft-ietf-httpbis-header-structure.html#ser-integer
    ...
    fn serialize_token(value: &str, output: &mut String) -> Res<()> {
    ...
    fn serialize_byte_sequence(value: &[u8], output: &mut String) -> Res<()> {
    ...
    fn serialize_bool(value: bool, output: &mut String) -> Res<()> {
...
mod test {
    ...
    fn serialize_header_errors() -> Result<(), Box<dyn Error>> {
        ...
        assert_eq!(
            ...
            Serializer::serialize(&disallowed_item)
        );
    ...
    fn serialize_dictionary_with_params() -> Result<(), Box<dyn Error>> {
        ...
        Dictionary::serialize(&input, &mut buf)?;
